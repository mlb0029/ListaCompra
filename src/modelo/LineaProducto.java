...
/**
 * Contiene información relativa a un producto almacenado en la lista de la
 * compra.
 * <p>
 * 
...
public class LineaProducto {
	 ...
	 * <p>
	 * Crea una instancia de la clase asignandole el nombre del producto, la
	 * cantidad a comprar y si se va a almacenar el producto como favorito o no.
	 ...
	 *            Cantidad del producto a comprar.
	 * @param esFavorito
	 *            Variable que indica si el producto está almacenado como
	 *            favorito o no.
	 */
	LineaProducto(Producto producto, Integer cantidad) {
		...
		// TODO Comprobar errores en LineaProducto(Producto producto, Integer
		// cantidad)
	}
	...
	/**
	 * Modifica la cantidad de producto que se desea comprar, siempre que no sea
	 * un valor negativo.
	 * 
	 * @param cantidad
	 *            Cantidad de un producto que se desea comprar.
	 * @return Devuelve true si se ha modificado la cantidad y false en caso
	 *         contrario.
	 */
	 ...
	 * 
	 * @return Devuelve true si el producto ha sido comprado y false en caso
	 *         contrario.
	 */
	...
	public String toString() {
		return "Producto:" + producto + ", Cantidad:" + cantidad + ", Esta Comprado:" + estaComprado + "\n";
	}
